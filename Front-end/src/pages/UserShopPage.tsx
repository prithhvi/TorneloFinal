...
/**
 * `UserShopPage` component displays the main shop interface for authenticated users,
 * including product listing, cart, and log out functionality.
 *
 * @component
 * @example
 * // Example usage of UserShopPage component:
 * <UserShopPage />
 */
